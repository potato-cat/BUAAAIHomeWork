...
class EightFigureMap(QGraphicsObject):
    ...
    def paint(self, painter, option, widget):
        ...
        painter.drawRoundedRect(0, 0, EIGHT_FIGURE_WIDTH,
                                EIGHT_FIGURE_HEIGHT, 10, 10)
        pass

    def boundingRect(self):
        return QRectF(0, 0, EIGHT_FIGURE_WIDTH,
                      EIGHT_FIGURE_HEIGHT)
    ...
    def move(self, operator, group=True):
        ...
        self.state = self.state.do_operation(operator)
        if operator == 0:  # down
